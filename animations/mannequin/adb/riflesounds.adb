  ...
  <rapid_fire>
   ...
   <Fragment BlendOutDuration="0.2" Tags="SDKRifle+rapid+FP">
    <ProcLayer>
     ...
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_w_rifle_fire_loop_fp"/>
       <StopTrigger value="Play_w_rifle_fire_loop_tail_fp"/>
       <SoundObstructionType value="Ignore"/>
       <AttachmentJoint value=""/>
       <Radius value="0"/>
       <IsVoice value="false"/>
   ...
   <Fragment BlendOutDuration="0.2" Tags="SDKRifle+rapid">
    <ProcLayer>
     ...
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_w_rifle_fire_loop_3p"/>
       <StopTrigger value="Play_w_rifle_fire_loop_tail_3p"/>
       <SoundObstructionType value="Ignore"/>
       <AttachmentJoint value=""/>
       <Radius value="0"/>
       <IsVoice value="false"/>
  ...
  <fire>
   <Fragment BlendOutDuration="0.2" Tags="SDKRifle+single+silencer+FP">
    <ProcLayer>
     ...
     <Procedural type="Audio">
      <ProceduralParams>
       <StartTrigger value="Play_w_rifle_fire_single_fp"/>
